...
def setup(app):
    ...
    app.add_stylesheet("css/theme_overrides.css")   # Fix childish RTD styles (tweak the worst offenders, at least)
...
release = __release__
# REV - Switched for use by RTD; the terms seem reversed from how they're used PEP404 - http://stackoverflow.com/q/34336383/656912
