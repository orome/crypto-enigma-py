...
|Python Programming Language| |PyPi| |Supported Python versions| |Development Status| |BSD3 License| |Build Status|
...
.. |Build Status| image:: https://travis-ci.org/orome/crypto-enigma-py.svg?branch=pypi
