...
def test_config_strings():
    ...
    assert cfg.config_string_internal('L', mark_func=lambda c: '[' + c + ']').split('\n') == ['L > ABCDEFGHIJK[L]MNOPQRSTUVWXYZ', '  P GBCXEFAHOJK[L]MNIPWZSTUVQDYR         IO.QW.AG.DX.ZR', '  1 PTHRLVXFDBZ[M]OQSUWNACEIGKYJ  E  16  III', '  2 YOCSLZBKRHAQ[M]VPWEUDGJNXTIF  I  15  II', '  3 UYKNJZWDBSRP[X]IMOETVGLHCFQA  F  14  V', '  4 LEYJVCNIXWPBQMDRTAKZGFU[H]OS  K  01  β', '  R RDOBJNT[K]VEHMLFCWZAXGYIPSUQ         c', '  4 RLFOBVUXHD[S]ANGYKMPZQWEJICT         β', '  3 ZIWHQXTVNECUODPLYK[J]RASGMBF         V', '  2 KGCSQZTJY[U]HEMVBOLIDXRNPWAF         II', '  1 SJTIUHWCVZXELRMANDOB[P]FQGYK         III', '  P GBCXEFAHOJKLMNI[P]WZSTUVQDYR         IO.QW.AG.DX.ZR', 'P < OGUSZKBIHVF[P]XTALWYDNCJQMRE']
    assert cfg.config_string_internal('L', mark_func=lambda c: 'β' + c + ']').split('\n') == ['L > ABCDEFGHIJKβL]MNOPQRSTUVWXYZ', '  P GBCXEFAHOJKβL]MNIPWZSTUVQDYR         IO.QW.AG.DX.ZR', '  1 PTHRLVXFDBZβM]OQSUWNACEIGKYJ  E  16  III', '  2 YOCSLZBKRHAQβM]VPWEUDGJNXTIF  I  15  II', '  3 UYKNJZWDBSRPβX]IMOETVGLHCFQA  F  14  V', '  4 LEYJVCNIXWPBQMDRTAKZGFUβH]OS  K  01  β', '  R RDOBJNTβK]VEHMLFCWZAXGYIPSUQ         c', '  4 RLFOBVUXHDβS]ANGYKMPZQWEJICT         β', '  3 ZIWHQXTVNECUODPLYKβJ]RASGMBF         V', '  2 KGCSQZTJYβU]HEMVBOLIDXRNPWAF         II', '  1 SJTIUHWCVZXELRMANDOBβP]FQGYK         III', '  P GBCXEFAHOJKLMNIβP]WZSTUVQDYR         IO.QW.AG.DX.ZR', 'P < OGUSZKBIHVFβP]XTALWYDNCJQMRE']
