...
print(component('II').mapping(-1, Direction.FWD))
print(component('III').mapping(2, Direction.FWD))
print(component('IV').mapping(-2, Direction.FWD))

print(component('VIII').mapping(11, Direction.REV))
print(component('B').mapping(-12, Direction.REV))
print(component('C').mapping(17, Direction.REV))
print(component('V').mapping(-8, Direction.REV))
...
# print(cfg.config_string())
#
# l = [str(cfg), unicode(cfg)]
# print(l)
# for x in l:
#     print(x)
#
# l =[str(cfgB), unicode(cfgB)]
# print(l)
# for x in l:
#     print(x)


# class UnicodePuzzler(object):
#
#     @staticmethod
#     def config(a):
#         print([a])
...
#     @staticmethod
#     def config_string(a):
#         #a, b = filter(lambda s: s != '', ab.decode('utf-8').split(' '))
#         a = a.decode('utf-8')
#         print([a])
#
#         UnicodePuzzler.config(a)
#
...
# UnicodePuzzler.config('ABγ')
# print('\n\nForced')
# UnicodePuzzler.config_string('ABγ XYZ')
# print('')
# UnicodePuzzler.config('ABγ', 'XYZ')